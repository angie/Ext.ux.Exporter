 ...
 * @extends Ext.Button
 * @author Nige White, with modifications from Ed Spencer, iwiznia with, yogesh and Angie Merryweather
 * Internally, this is just a link.
 * Pass it either:
 *  * an Ext.Component subclass with a 'store' property
 *  * a ComponentQuery of that component
 *  * a store
 *  * nothing (and it will try to grab the first parent of this button that is a grid or tree panel)
 *
...
Ext.define('Ext.ux.exporter.ExporterButton', {
    ...
    onClick: function() {
        ...
        Ext.ux.exporter.FileSaver.saveAs(res.data, res.mimeType, res.charset,
            filename, link, remote, me.onComplete, me);
